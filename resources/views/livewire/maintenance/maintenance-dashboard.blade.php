<div class="mt-6 font-sans text-[#070642]">
    ...
    {{-- 1. TOP TOOLBAR: TABS + ACTION BUTTON --}}
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        {{-- LEFT COLUMN: REQUEST LIST (1/3 Width) --}}
        <div class="lg:col-span-4 flex flex-col gap-4">
            ...
            <div class="flex flex-col gap-3 max-h-[800px] overflow-y-auto custom-scrollbar pr-2">
                @foreach($requests as $req)
                    @php
                        $isActive = $selectedRequestId == $req->request_id;
                    @endphp
                            ...
                            <div class="text-right">
                                ...
                                <div class="flex items-center gap-2">
                                    <span class="w-2 h-2 rounded-full 
                                        {{ str_contains($selectedDetail->urgency, '1') || str_contains($selectedDetail->urgency, '2') ? 'bg-red-400' : 'bg-green-400' }}">
                                    </span>
                    ...
                    <div class="p-8">
                        ...
                        <div class="bg-[#F8F9FD] rounded-2xl p-6 mb-8">
                            <div class="mb-4">
                                ...
                                <span class="text-[#070642] font-semibold text-lg">
                                    {{ \Carbon\Carbon::parse($selectedDetail->log_date)->format('F d, Y') }}
                                </span>
                            </div>
                        ...
                        <div class="flex gap-4 pt-4 border-t border-gray-100">
                            <button class="flex-1 bg-[#2B66F5] hover:bg-blue-600 text-white font-bold py-3 px-6 rounded-xl transition-colors shadow-lg shadow-blue-200">
                                Delete
                            </button>
                            <button class="flex-1 bg-[#070642] hover:bg-blue-900 text-white font-bold py-3 px-6 rounded-xl transition-colors shadow-lg">
                                Resolved
                            </button>
                        </div>
