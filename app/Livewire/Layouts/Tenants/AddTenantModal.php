...
class AddTenantModal extends Component
{
    ...
    private function resetForm()
    {
        $this->reset([
            'mode',
            'transferFromTenantId', 'currentLeaseId', 'currentBedId',
            'profilePicture', 'existingProfileImg',
            'firstName', 'lastName', 'gender',
            'phoneNumber', 'email',
            'selectedBuilding', 'selectedUnit', 'selectedBed',
            'dormType', 'term', 'startDate', 'shift', 'autoRenew',
            'moveInDate', 'monthlyRate', 'securityDeposit',
